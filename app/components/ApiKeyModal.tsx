...
export function ApiKeyModal({ onKeySet }: ApiKeyModalProps) {
  ...
  function handleSave() {
    ...
    // Small delay so the button flicker feels intentional
  ...
  return (
    <div className="modal-backdrop">
      <div className="animate-modal" style={{ width: "100%", maxWidth: "460px" }}>
        <RetroWindow title="MISSION_CONFIG.EXE" variant="fire">
          <div
            style={{
